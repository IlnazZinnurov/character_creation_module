...
def attack(char_name: str,
           char_class: str) -> str:
    """Функция атаки выбранного персонажа."""
...
def defence(char_name: str,
            char_class: str) -> str:
    """Функция защиты выбранного персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str,
            char_class: str) -> str:
    """Функция применения специального умения выбранного персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str,
                   char_class: str) -> str:
    """Функция начала тренировки выбранного персонажа"""
    if char_class == 'warrior':
